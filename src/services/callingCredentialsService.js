...
// upserting into calling_credentials keyed on its unique firebase_uid AND unique
// phone_number columns. Kept current so the dialplan (func_odbc CALLING_CRED_UID /
// firebase_lookup.php) can resolve which Firebase user owns an inbound
